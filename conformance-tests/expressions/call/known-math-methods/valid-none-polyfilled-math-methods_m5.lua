...
Math.trunc(3.143) --[[ ROBLOX NOTE: Math.trunc is currently not supported by the Luau Math polyfill, please add your own implementation or file a ticket on the same ]]
