-- ROBLOX upstream: https://github.com/Roblox/js-to-lua/blob/sha/conformance-tests/expressions/member/known-number-methods/valid-properties-index-expression_m5.js
