-- ROBLOX upstream: https://github.com/Roblox/js-to-lua/blob/sha/conformance-tests/comments/variable-declaration-with-object-expression-and-multiple-comments_m5.ts
